...
def extract_llm_features(df):
    """
    Input: df con [TIMESTAMP, LOG_TYPE, LLM_MODEL_ID, LLM_STATUS, LLM_COST_USD, LLM_RESPONSE_TIME_MS]
    Output: features para IF
    """
    df = df.copy()
    ...
    # Response time: normalize (200 - 34999 ms)
